...
<div id="video-content" class="<?php if(has_list()){ echo "span77";} else {echo "row-fluid block";}?>" style="height:<?php echo $height;?>px">
<?php echo _ad('1');?>
<div id="video-wrapper">
<div class="video-player pull-left" style="height:<?php echo $height;?>px">
<?php echo $embedvideo; ?>
...
<?php if(has_list()){ ?>
<div class="video-under-right nomargin pull-right span4">
...
<div class="addiv pull-right">
<a id="embedit" href="javascript:void(0)" class="tipW" title="<?php echo _lang('Embed video');?>"><i class="icon-youtube-play"></i> <?php echo _lang('Embed Code');?></a>
<?php if ($video->media <>  3) { 
...
<?php } ?>
<a id="report" href="javascript:void(0)" class="tipW" title="<?php echo _lang('Report video');?>"><i class="icon-flag"></i> <?php echo _lang('Report');?></a>
</div>
</div>
</div>
