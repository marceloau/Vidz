<div class="row-fluid clearfix"  style="margin-left: 10px;">
<?php if(isset($msg)) { echo $msg; } ?>
<form class="styled top20 bottom20 span12 profile-up" action="<?php echo canonical();?>/" enctype="multipart/form-data" method="post">
<div class="box">
<div class="box-head">
