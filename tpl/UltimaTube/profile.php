...
<div class="clearfix"></div>
<ul class="psocial">
<?php if($profile->fblink) { ?> <li> <a href="https://facebook.com/<?php echo $profile->fblink;?>" rel="nofollow" target="_blank"><i class="icon-facebook-sign"></i></a> </li><?php } ?>
<?php if($profile->glink) { ?> <li> <a href="https://plus.google.com/<?php echo $profile->glink;?>" rel="nofollow" target="_blank"><i class="icon-google-plus"></i></a> </li><?php } ?>
<?php if($profile->twlink) { ?> <li> <a href="https://twitter.com/<?php echo $profile->twlink;?>" rel="nofollow" target="_blank"><i class="icon-twitter"></i></a> </li><?php } ?>
