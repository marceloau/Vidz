...
<?php if(get_option('player-logo')) { ?><p><img src="<?php echo thumb_fix(get_option('player-logo')); ?>"/> <br /> <a href="<?php echo admin_url('players');?>&ac=remove-logo">Remove</a></p><?php } ?>
	...
	<label class="radio inline"><input type="radio" name="choosen-player" class="styled" value="4" <?php if(get_option('choosen-player') == 4 ) { echo "checked"; } ?>>TelaVideos Chameleon</label>
