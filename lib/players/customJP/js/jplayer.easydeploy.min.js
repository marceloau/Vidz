function setck(e, a, t, i, n, s) {
    var r = new Date;
    r.setTime(r.getTime()), t && (t = 1e3 * t * 60 * 60 * 24);
    var o = new Date(r.getTime() + t);
    document.cookie = e + "=" + escape(a) + (t ? ";expires=" + o.toGMTString() : "") + (i ? ";path=" + i : "") + (n ? ";domain=" + n : "") + (s ? ";secure" : "")
}
        ...
        function a(a, t, i, n) {
            ...
            var o = {
                ...
                volumechange: function (t) {
                    t.jPlayer.options.muted ? e(a + " .currentVolume").val(0) : e(a + " .currentVolume").val(t.jPlayer.options.volume), setck("jplayer-volume", t.jPlayer.options.volume, 386)
                },
